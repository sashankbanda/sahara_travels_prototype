...
export const WhatsAppButton = () => {
    ...
    return (
        <a
            ...
            className="fixed bottom-4 right-4 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.3)] hover:bg-[#20bd5a] hover:scale-110 hover:shadow-[0_6px_16px_rgba(0,0,0,0.4)] transition-all duration-300 group"
