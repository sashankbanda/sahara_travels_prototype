...
export const WhatsAppButton = () => {
    ...
    return (
        <a
            ...
            className="fixed bottom-4 right-4 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-b from-[#4ADE80] to-[#25D366] text-white shadow-[inset_0_4px_6px_rgba(255,255,255,0.5),inset_0_-4px_6px_rgba(0,0,0,0.1),0_10px_15px_-3px_rgba(37,211,102,0.4)] border border-white/20 hover:scale-110 hover:-translate-y-1 transition-all duration-300 group"
