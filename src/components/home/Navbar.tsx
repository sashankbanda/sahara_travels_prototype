...
export const Navbar = () => {
    ...
    const targetWidth = isMobile ? "95%" : (isTablet ? "90%" : (isLaptop ? "85%" : "75%"));
        ...
        <>
            ...
            >
                <motion.div
                    ...
                    className="pointer-events-auto px-6 md:px-10 py-2 flex items-center justify-between border transition-all duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] group hover:bg-white/10 relative"
                >
                    {/* Brand */}
                    <Link
                        href="/"
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {/* Language Dropdown */}
                        <div className="hidden lg:flex items-center gap-1 text-white hover:text-white/80 cursor-pointer transition-colors text-[10px] uppercase font-medium tracking-widest mr-4">
                            <span>EN</span>
