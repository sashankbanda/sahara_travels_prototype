...
export function PackageForm({ initialData, onSubmit, isSubmitting }: PackageFormProps) {
    ...
    return (
        <div className="max-w-3xl mx-auto">
            <div className="mb-6">
                <Button variant="ghost" type="button" onClick={() => router.push("/admin/tours")} className="gap-2 pl-0 hover:pl-2 transition-all">
                    <ArrowLeft className="w-4 h-4" />
                    Back to Tours
                </Button>
            </div>

            <div className="glass-card p-6 md:p-8 rounded-xl bg-black/40 border border-white/10">
                <Form {...form}>
