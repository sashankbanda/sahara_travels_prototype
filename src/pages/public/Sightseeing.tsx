            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center px-6">
                    ...
                    >
                        ...
                        <h1 className="font-serif text-5xl md:text-7xl mb-6">Sightseeing</h1>
                ...
                <div className="container mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {sightseeing.map((pkg, index) => (
                            ...
                            >
                                <Link to={`/packages/${pkg.id}`} className="group block bg-zinc-900 rounded-sm overflow-hidden border border-white/5 hover:border-primary/30 transition-colors duration-500">
